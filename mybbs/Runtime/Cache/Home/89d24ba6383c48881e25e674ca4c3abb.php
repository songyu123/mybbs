...
<div class="title">
    ...
    <div class="caoZuo"><div class="manageDiv">
        <div class="leftManageDiv">
            <ul>
                <a id="manageUser" href="<?php echo U('Manage/usermanage');?>"><li>管理员中心</li></a>
                <li>个人留言</li>
                <a href="<?php echo U('Manage/recycle');?>"><li>留言回收站</li></a>
            </ul>
        </div>
        <div class="userLunManage">
            ...
            <table class="table" cellspacing="0" cellpadding="0">
                ...
                <?php if(is_array($UserMess)): $i = 0; $__LIST__ = $UserMess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($mess["mbtitle"]); ?></td>
                    <td><?php echo ($mess["mbdate"]); ?></td>
                    <td><?php echo ($mess["mbip"]); ?></td>
                    <td>
                        <span><a href="<?php echo U('Manage/updateMessage');?>?mbid=<?php echo ($mess["mbid"]); ?>">删除留言</a></span>
