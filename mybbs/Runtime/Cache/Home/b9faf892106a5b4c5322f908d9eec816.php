        ...
        <div class="caoZuo">  <div class="index">
            <div class="huaTi">
                <div class="indexLeft " >
                    ...
                    <div>
                        <ul>
                            <?php if(is_array($NewMess)): $i = 0; $__LIST__ = $NewMess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li style="border-bottom: 1px dashed #808080;width:270px;margin-left: -25px">
                                <a href="<?php echo U('Show/showManage');?>?mbid=<?php echo ($new["mbid"]); ?>"><?php echo ($new["mbtitle"]); ?></a>----<?php echo ($new["mbdate"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                ...
                <div class="indexcontent ">
                    <h3>最热话题</h3>
                    <ul>
                        <?php if(is_array($HostMess)): $i = 0; $__LIST__ = $HostMess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$host): $mod = ($i % 2 );++$i;?><li style="border-bottom: 1px dashed #808080;width:270px;margin-left: -25px">
                                <a href="<?php echo U('Show/showManage');?>?mbid=<?php echo ($host["mbid"]); ?>"><?php echo ($host["mbtitle"]); ?></a>----<?php echo ($host["mbdate"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
                <div class="indexright ">
                    <h3>推荐话题</h3>
                    <ul>
                        <?php if(is_array($TuiMess)): $i = 0; $__LIST__ = $TuiMess;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tui): $mod = ($i % 2 );++$i;?><li style="border-bottom: 1px dashed #808080;width:270px;margin-left: -25px">
                                <a href="<?php echo U('Show/showManage');?>?mbid=<?php echo ($tui["mbid"]); ?>"><?php echo ($tui["mbtitle"]); ?></a>----<?php echo ($tui["mbdate"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
        </div>
